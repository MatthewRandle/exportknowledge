...
const getAllCourses = `
    SELECT courses.url, courses.title, courses.preview_description as "description", courses.image, sum(courses_parts.length) as "length", courses.video, courses.what_learn as "whatLearn", courses.who_for as "whoFor"
    FROM courses
    ...
    GROUP BY courses.url, courses.title, courses.preview_description, courses.image, courses.video, courses.what_learn, courses.who_for;`

                ...
                <div className="editCourse_form">
                    <Formik
                        ...
                        initialValues={{
                            ...
                            prerequisites: props.course ? props.course.prerequisites : ""
                        }}
                        onSubmit={(values) => {
                            props.submit(
                                props.course ? props.course.id || null : null,
                                values.url,
                                values.title,
                                values.image,
                                values.preview,
                        ...
                        render={({
                            ...
                            handleChange
                                ...
                                <form autoComplete="off" onSubmit={handleSubmit}>
                                    ...
                                    <br />
                                    <button type="button" onClick={() => props.delete(props.course ? props.course.id || null : null)}>
                                        Delete
                                    </button>

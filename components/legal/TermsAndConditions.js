        ...
        return(
            <div className="legal_container pushFooter">
                <div className="legal">
                    ...
                    <h2>Cookies</h2>
                    <p>
                        We employ the use of cookies. By using export Knowledge's website you consent to the use of cookies
	                    in accordance with export Knowledge’s privacy policy.
                    </p>
                    <p>
                    ...
                    <br/>
                    <p>For more information on what cookies we store and how you can enable/disable them can be found <Link href="/cookie-policy"><a>here</a></Link></p>


                    
                    <h2>License</h2>
                    <p>
                        Unless otherwise stated, export Knowledge and/or it’s licensors own the intellectual property rights for
                        all material on export Knowledge. All intellectual property rights are reserved. You may view and/or print
	                    pages from https://exportknowledge.com for your own personal use subject to restrictions set in these terms and conditions.
                    </p>
                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from https://exportknowledge.com</li>
                        <li>Sell, rent or sub-license material from https://exportknowledge.com</li>
                        <li>Reproduce, duplicate or copy material from https://exportknowledge.com</li>
                        <li>Redistribute content from export Knowledge (unless content is specifically made for redistribution).</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            material and data ('Comments') in areas of the website. export Knowledge does not screen, edit, publish
                            or review Comments prior to their appearance on the website and Comments do not reflect the views or
                            opinions ofexport Knowledge, its agents or affiliates. Comments reflect the view and opinion of the
                            person who posts such view or opinion. To the extent permitted by applicable laws export Knowledge shall
                        ...
                        <li>
                            export Knowledge reserves the right to monitor all Comments and to remove any Comments which it considers
                        ...
                        <li>
                            You hereby grant to <strong>export Knowledge</strong> a non-exclusive royalty-free license to use, reproduce,
                    ...
                    <p>
                        This Terms and conditions page was created at <Link href="https://termsandconditionstemplate.com"><a>termsandconditionstemplate.com</a></Link> generator. If you have
